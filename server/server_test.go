...
import (
	...
	"klever/grpc/databases"
	"klever/grpc/databases/config"
	mocks "klever/grpc/databases/mocks/databases"
...
func TestNewDatabase(t *testing.T) {
	...
	db := databases.Database(conf, dbClient)
...
func TestRestOfInternalCode(t *testing.T) {
	...
	db := databases.Database(conf, client)
	...
	// mongoPanics = func() {
	// 	db.Collection("non-fake-existing-collection").FindOneAndUpdate(timeoutCtx, result, nil)
	// }
	// assert.Panics(t, mongoPanics)
